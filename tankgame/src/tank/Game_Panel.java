...
public abstract class Game_Panel extends JPanel implements Runnable {
  
    protected final String BACKGROUND_IMAGE = "resource/Background.bmp";
    protected final String TANK_IMAGE = "resource/TankImage.png";
    ...
    protected ArrayList<GameAnime> game_animation;
    ...
    public Game_Panel() {
        try {
          ...
          this.breakable_wall = new Wall("resource/Wall1.gif");
    ...
    public void doAnimation( GameAnime animation ) {
